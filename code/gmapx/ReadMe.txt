========================================================================
		ActiveX Control DLL : GMAPX
========================================================================

ControlWizard has created this project for your GMAPX ActiveX Control
...
that make up your GMAPX ActiveX Control DLL.
...
GmapxCtl.h
	This file contains the declaration of the CGmapxCtrl C++ class.

GmapxCtl.cpp
	This file contains the implementation of the CGmapxCtrl C++ class.

GmapxPpg.h
	This file contains the declaration of the CGmapxPropPage C++ class.

GmapxPpg.cpp
	This file contains the implementation of the CGmapxPropPage C++ class.

GmapxCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CGmapxCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file gmapx.rc.

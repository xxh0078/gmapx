...
// Dispatch maps
	...
	afx_msg long SetMapToolVisible(long lType, long lVisible);
	afx_msg long SetMarkFile(LPCTSTR strFileName);
	afx_msg BSTR GetScreenXY(double dMapX, double dMapY);
	afx_msg long SetMapLineVisible(long rid, long lVisible);
	afx_msg long SetMapPointAngle(long pid, long lAngle);
	//}}AFX_DISPATCH
...
public:
	...
	dispidSetMapToolVisible = 57L,
	dispidSetMarkFile = 58L,
	dispidGetScreenXY = 59L,
	dispidSetMapLineVisible = 60L,
	dispidSetMapPointAngle = 61L,

// MD5.h: interface for the MD5Checksum class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_MD5_H__2BC7928E_4C15_11D3_B2EE_A4A60E20D2C3__INCLUDED_)
#define AFX_MD5_H__2BC7928E_4C15_11D3_B2EE_A4A60E20D2C3__INCLUDED_
...
public:
	...
	static char* GetMD5(BYTE* pBuf, UINT nLength);
//	static char* GetMD5(CFile& File);
	//static char* GetMD5(const CString& strFilePath);
	static unsigned char * GetMD5( unsigned char* pSourceBuf, unsigned int nSourceLength, unsigned char pResultBuf[ 32 ] );
...
protected:
	...
	char* Final();
	unsigned char * Final( unsigned char pResultBuf[ 32 ] );
...
#endif // !defined(AFX_MD5_H__2BC7928E_4C15_11D3_B2EE_A4A60E20D2C3__INCLUDED_)

...
#include<fstream>
unsigned char g_Memery[1024*300];//全局内存，仅供地图图片加载临时使用
// --------
// PngImage
// --------
/**
...
unsigned char* PngImage::doConvertRGB8(png_structp& PngPtr, png_infop& InfoPtr) const
{
	...
	// allocate memory
	unsigned char* bgra = g_Memery;//new unsigned char[size];
...
unsigned char* PngImage::doConvertRGBA8(png_structp& PngPtr, png_infop& InfoPtr) const
{
	...
	// allocate memory
	unsigned char* bgra = g_Memery;//new unsigned char[size+1024];

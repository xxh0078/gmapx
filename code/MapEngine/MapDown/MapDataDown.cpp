...
// 	h = ::CreateThread( NULL,0 ,&CMapDataDown::DownLoadProc,this,0,&dwThreadID );
// 	h = ::CreateThread( NULL,0 ,&CMapDataDown::DownLoadProc,this,0,&dwThreadID );
// 	h = ::CreateThread( NULL,0 ,&CMapDataDown::DownLoadProc,this,0,&dwThreadID );
	//	h = ::CreateThread( NULL,0 ,&CDownLoad::DownLoadProc,this,0,&dwThreadID );
	//影像数据下载线程
	//	h = ::CreateThread( NULL,0 ,&CDownLoad::DownLoadImageProc,this,0,&dwThreadID );
	//	h = ::CreateThread( NULL,0 ,&CDownLoad::DownLoadImageProc,this,0,&dwThreadID );
	//	h = ::CreateThread( NULL,0 ,&CDownLoad::DownLoadImageProc,this,0,&dwThreadID );
	//	h = ::CreateThread( NULL,0 ,&CDownLoad::DownLoadImageProc,this,0,&dwThreadID );
	CloseHandle( h );
